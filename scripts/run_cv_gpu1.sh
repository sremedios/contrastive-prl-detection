#!/usr/bin/env bash
# Folds 3 and 4 of the 5-fold CV, in series on cuda:1.
#
# Pair with run_cv_gpu0.sh, which takes folds 0-2 on cuda:0; launch the two
...
#     DEVICE=cuda:2 OUT_DIR=runs/cv5_rerun ./scripts/run_cv_gpu1.sh
